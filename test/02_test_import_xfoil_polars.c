...
int main() {
    ...
    if (polar1.Re == 300000
        ...
        unload_polar_from_memory(&polar1);
        return 0;
    }
    ...
    if (polar2.Re == 30000
                && polar2.alpha[2] == deg2rad(-14.000)
                && polar2.CL[0] == -0.4209
                && polar2.CD[polar2.size-1]==0.15644
                && polar2.size==61) {
        ...
        unload_polar_from_memory(&polar1);
        unload_polar_from_memory(&polar2);
        return 0;
    }
    ...
    if (airfoil3.size == 2
        ...
        unload_polar_from_memory(&polar1);
        unload_polar_from_memory(&polar2);
        unload_airfoil_from_memory(&airfoil3);
        return 0;
    }
    ...
    if (airfoil4.size == 5
                && airfoil4.polars[0].alpha[0] == deg2rad(-15.0)
                && airfoil4.polars[4].alpha[30] == deg2rad(+15.0)
                && airfoil4.polars[2].CL[15] == 0.50) {
        ...
        unload_polar_from_memory(&polar2);
        unload_airfoil_from_memory(&airfoil3);
        unload_airfoil_from_memory(&airfoil4);
        return 0;
    }
